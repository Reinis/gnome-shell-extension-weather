...
const WEATHER_DEBUG_EXTENSION = 'debug-extension';                              // Weather extension setting
    ...
    this.UI.currentHumidity.text = this.info.get_humidity();
    this.status("Basics informations "+di_up);
    }
    ...
    this.UI.menuConditions = new St.Label({ y_align: Clutter.ActorAlign.CENTER, text: _('Weather') });
