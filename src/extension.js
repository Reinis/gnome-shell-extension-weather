...
const Weather = new Lang.Class({
    ...
    start : function() {                                                        this.status("Starting Weather");
        ...
        if (this.city_name) {                                                   this.status("Location ("+this.city_name+") loaded");
            ...
            this.infoC = this.info.connect("updated",function(){that.refresh();that.status(0);});
    ...
    stop : function() {                                                         this.status("Stopping Weather");
        if (this.timer) {
    ...
    refresh : function() {                                                      this.status("Refreshing");
        let that = this;
    ...
    loadForecast : function() {                                                 this.status("Load forecast object");
        let forecast = [];
        let day = 0;
        let hour = 0;
